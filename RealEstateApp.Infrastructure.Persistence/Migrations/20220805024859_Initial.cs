    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyImgs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyUpgrade", x => new { x.PropertyId, x.UpgradeId });
                    table.ForeignKey(
                        name: "FK_PropertyUpgrade_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyUpgrade_Upgrades_UpgradeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyImgs_PropertyId",
                table: "PropertyImgs",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyUpgrade_UpgradeId",
                table: "PropertyUpgrade",
                column: "UpgradeId");
        }
